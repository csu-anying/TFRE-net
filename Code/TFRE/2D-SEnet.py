...
class ResBlock1(nn.Module):
    ...
    def __init__(self, filters):
        ...
        self.conv2d0 = nn.Sequential(
            nn.Conv2d(1, filters // 2, kernel_size=(3, 21), padding=((3 - 1) // 2, (21 - 1) // 2)),
            nn.BatchNorm2d(filters // 2),
            nn.LeakyReLU(0.3)
        )

        self.conv2d1 = nn.Sequential(
            nn.Conv2d(filters // 2, filters, kernel_size=(5, 17), padding=((5 - 1) // 2, (17 - 1) // 2)),
            nn.BatchNorm2d(filters),
            nn.LeakyReLU(0.3)
        )

        self.conv2d2 = nn.Sequential(
            nn.Conv2d(filters, filters, kernel_size=(7, 11), padding=((7 - 1) // 2, (11 - 1) // 2)),
            nn.BatchNorm2d(filters),
            nn.LeakyReLU(0.3)
        )

        self.conv2d3 = nn.Sequential(
            nn.Conv2d(filters, filters, kernel_size=(11, 7), padding=((11 - 1) // 2, (7 - 1) // 2)),
            nn.BatchNorm2d(filters),
            nn.LeakyReLU(0.3)
        )
...
class ResBlock2(nn.Module):
    ...
    def __init__(self, filters):
        ...
        self.conv2d0 = nn.Sequential(
            ...
            nn.LeakyReLU(0.3),
            nn.Conv2d(filters0, filters // 2, kernel_size=(3, 1), padding=((3 - 1) // 2, 0)),
            nn.BatchNorm2d(filters // 2),
            nn.LeakyReLU(0.3),
            nn.Dropout(0.5),
            nn.Conv2d(filters // 2, filters // 2, kernel_size=(5, 1), padding=((5 - 1) // 2, 0))
        )
...
class SEnet(nn.Module):
    ...
    def __init__(self):
        ...
        self.blk1 = ResBlock1(4)
        self.blk2 = ResBlock2(4)
